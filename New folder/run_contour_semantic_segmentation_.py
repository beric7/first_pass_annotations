...
destination = './contours_2_pass/'
text_dest = './text_2_pass/'
json_dest = './json_2_pass/'
...
for image_name in tqdm(ohev_list_array): 
    ...
    for class_name in class_dictionary:
        complete_class_contours = contour_class(dce_pass, ohev_file_name, image_file_name, destination, image_name, class_dictionary[class_name], class_name)
